...
$("body").append('<div class="fixed-button active"><a href="https://www.facebook.com/HuFoot" target="_blank" class="btn btn-md btn-primary"><i class="ti-facebook" aria-hidden="true"></i>HuFoot</a> </div>');var $window=$(window),nav=$(".fixed-button");
