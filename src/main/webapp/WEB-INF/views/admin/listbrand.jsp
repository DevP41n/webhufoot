...
<c:url var="brandURL" value="/listbrand" />
					...
					<div class="page-body">
						...
						<c:if test="${not empty message}">
							...
							<div class="card-header">
								...
								<c:url var="createBrandURL" value="/addbrand"/>
												<a flag="info"
												   class="dt-button buttons-colvis btn btn-white btn-primary btn-bold" data-toggle="tooltip"
												   title='Thêm thương hiệu' href='${createBrandURL}'>
															<span>
										...
										<c:forEach var="item" items="${model.listResult}">
											<tr>
												...
												<a class="btn btn-sm btn-primary btn-edit" data-toggle="tooltip"
														title="Cập nhật thương hiệu" href='${addbrandURL}'><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
												</a>
												</td>
											</tr>
											</c:forEach>
			...
			function deleteBrand(data) {
		        $.ajax({
		            ...
		            success: function (result) {
		                window.location.href = "${brandURL}?page=1&limit=5&message=delete_success";
		            },
		            error: function (error) {
		            	window.location.href = "${brandURL}?page=1&limit=5&message=error_system";
		            } 
		        });
		    }
</script>
